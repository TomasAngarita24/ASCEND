...
const styles: Record<string, React.CSSProperties> = {
  ...
  avatarInitial: { fontSize: 'clamp(1.5rem, 5vw, 2.2rem)', fontWeight: 800, color: 'var(--bg-color)' },
  headerInfo: { display: 'flex', flexDirection: 'column', gap: '0.4rem', flex: 1, minWidth: 0 },
  userName: { fontSize: 'clamp(1.4rem, 5vw, 1.8rem)', fontWeight: 800, color: 'var(--text-primary)' },
  userEmail: { fontSize: '1rem', color: 'var(--text-muted)', wordBreak: 'break-word' },
  userBio: { fontSize: '0.95rem', color: 'var(--text-secondary)', fontStyle: 'italic', lineHeight: 1.4, marginTop: '0.2rem' },
  countersRow: { display: 'flex', gap: 'clamp(1rem, 4vw, 2.5rem)', marginTop: '0.75rem', flexWrap: 'wrap' },
